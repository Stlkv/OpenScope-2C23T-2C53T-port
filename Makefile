...
SRCS := src/startup.c src/board.c src/display.c src/font.c src/dmm.c src/dmm53.c src/meter_data.c src/settings.c src/fpga.c src/scope.c src/siggen.c src/fw_update.c src/screenshot.c src/w25q.c src/usb_msc.c src/ui.c src/main.c src/fft.c src/arb_csv.c
